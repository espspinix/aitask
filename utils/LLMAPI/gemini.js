...
//import { DEBUG_GEMINI, DEBUG_GEMINI_LEVEL } from "../../imageProcessing/config.js"; // Import config constants
import util from 'util'; // For util.inspect

const DEBUG_GEMINI = true;
const DEBUG_GEMINI_LEVEL = "stats"; //stats
